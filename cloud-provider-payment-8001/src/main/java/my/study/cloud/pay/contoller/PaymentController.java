...
public class PaymentController {
    ...
    public CommonResult create(@RequestBody Payment payment){
        ...
        if(result>0){
            return new CommonResult(200,"入库成功serverPort:"+serverPort,result);
        }else{
            return new CommonResult(444,"入库失败",null);
        }
    }
